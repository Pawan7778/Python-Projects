...
img3 = pygame.image.load("snake.jpg")
img3 = pygame.transform.scale(img3, (screen_width, screen_height)).convert_alpha()
...
def welcome():
    exit_game = False
    while not exit_game:
        gameWindow.fill((233,210,229))  #(rbg color)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load('uddgaye.mpeg')
